  ...
  <div class="layout">
    <aside class="sidebar" role="navigation" aria-label="Main sidebar">
      ...
      <nav>
        ...
        <a href="{{ route('payrollprocessing') }}" class="nav-link {{ request()->routeIs('payrollprocessing') ? 'active' : '' }}">
          <span class="icon"><i class="bi bi-credit-card-fill"></i></span><span>Payroll Processing</span>
        </a>
